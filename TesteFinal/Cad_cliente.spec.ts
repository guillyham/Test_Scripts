...
import { randomSelect, randomSelect2, login, validateFields, waitForAjax, 
        contratoStart, contratoFinaliza, camposOpcionaisContratos, contratoAtiva } from '../lib/utils';
import fs from 'fs';
...
// Salva o cogido do cliente no arquivo .json
